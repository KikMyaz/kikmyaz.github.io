// Mondly = type=http-response,pattern=^https:\/\/api\.mondlylanguages\.com\/v3\/ios\/user\/(login|sync),requires-body=1,script-update-interval=-1,script-path=https://raw.githubusercontent.com/KikMyaz/kikmyaz.github.io/test/docs/rules/mondly.js
