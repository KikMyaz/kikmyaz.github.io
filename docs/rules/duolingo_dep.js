...
// DuolingoLogin= type=http-response,pattern=https://ios-api-2.duolingo.com/*/login,requires-body=1,script-path=https://raw.githubusercontent.com/KikMyaz/kikmyaz.github.io/test/docs/rules/duolingo_login.js
...
// DuolingoAds = type=http-response,pattern=https://googleads.g.doubleclick.net/getconfig/pubsetting*,max-size=0,requires-body=true,timeout=10,script-update-interval=60,script-path=https://raw.githubusercontent.com/KikMyaz/kikmyaz.github.io/test/docs/rules/duolingo_ads.js
...
// Duolingo= type=http-response,pattern=https://duolingo-leaderboards-prod.duolingo.com/leaderboards/*,requires-body=1,script-path=https://raw.githubusercontent.com/KikMyaz/kikmyaz.github.io/test/docs/rules/duolingo.js
