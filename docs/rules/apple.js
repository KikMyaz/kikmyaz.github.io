...
;
var msWIXRWl1 = JSON['parse']($response['body']);
var $iKNQKE2 = msWIXRWl1['receipt']["bundle_id"];
if ($iKNQKE2 == "com.video.magicam") {
    msWIXRWl1 = {
        "status": 0,
...
if ($iKNQKE2 == "com.camerasideas.InstaShot") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.camerasideas.Peachy") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.icandiapps.nightsky") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.appcubby.launchpro") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.speed.test.internet") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.inscopy.instake") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
            "adam_id": 1482740849,
...
if ($iKNQKE2 == "net.shinyfrog.bear-iOS") {
    msWIXRWl1 = {
        status: 0,
        environment: "Production",
        receipt: {
            ...
            $iKNQKE2: "net.shinyfrog.bear-iOS",
...
if ($iKNQKE2 == "com.alphatech.manly") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.sugarmo.ScrollClip") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.apperto.videorama") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.binchen.remote.files") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.mammoth.lazybones.lazybones") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.abishkking.maleworkout") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "studio.2players.Wardrobe") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
            "adam_id": 1344153452,
...
if ($iKNQKE2 == "com.fishmobi.geniusart") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "solutions.wzp.translator") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.CalculatorForiPad.InternetRocks") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.vitotechnology.StarWalk") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.macpaw.iosgemini") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.jpspso.Delete-photos") {
    msWIXRWl1 = {
        "status": 0,
        "environment": "Production",
        "receipt": {
...
if ($iKNQKE2 == "com.qingcheng.filex") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.heliang.super.widget") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
            "adam_id": 1569291816,
...
if ($iKNQKE2 == "app.lockscreen.AnyWidget") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.iuuapp.audiomaker") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.unhonin.MonitorPlus") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.maxty.gofitness") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.funnmedia.fitnessview") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.mobisystems.MSTranslator") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.septudio.SSHClientLite") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "retouch.remove.object") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "me.imgbase.videoday") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "it.beatcode.clipboardpro") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "me.imgbase.intolive") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.jozeal.recorder") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "health.sleep.sounds.tracker.alarm.calm") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.MonkeyTaps.Motivation") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.teadoku.flashnote") {
    msWIXRWl1 = {
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.vgfit.waterreminder") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.mediaeditor.video") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.JinyuMeng.WillItRain") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.loveyouchenapps.knockout") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
...
if ($iKNQKE2 == "com.mirmay.DownloaderFREE") {
    msWIXRWl1 = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
