...
// Memrise = type=http-response,pattern=^https:\/\/api\.memrise\.com\/v1\.20\/me\/paths\/.+,requires-body=1,script-path=https://raw.githubusercontent.com/KikMyaz/kikmyaz.github.io/test/docs/rules/memrise.js
// api.memrise.com
